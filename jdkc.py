...
goods = [ # 这里填写商品网址，以及你期望的价格，格式如下，可以填写多个商品
         {'url':'https://item.jd.com/26158061692.html', 'expected_price': 63.00},
         {'url':'https://item.jd.com/10128695893.html', 'expected_price': 63.00},
         {'url':'https://item.jd.com/38369776842.html', 'expected_price': 63.00},
         {'url':'https://item.jd.com/10125940774.html', 'expected_price': 63.00},
         {'url':'https://item.jd.com/100022967802.html', 'expected_price': 18.20}
]
push_token = '55683a4d15924a18b99b0c434bf1e702'  # 设置pushplus用于推送信息的token，如没有，可以去http://www.pushplus.plus/免费注册一个！
message_title = '恭喜'  # 推送信息标题
message_contents = '你所关注的 《 {} 》 当前商品：{}，现在价格是：{} 已经符合您设置的预期价格，快点下单吧。 {}'  # 推送信息内容
guding_cookie = True  # 是否设置固定京东cookie值，如果需要全自动化，需要启用（True），并修改jd_cookie_v
jd_cookie_v = 'commonAddress=0; mitemAddrName=; wq_addr=; jdAddrId=; jdAddrName= regionAddress=;commonAddress=2089432507; mitemAddrName=%u6D59%u6C5F%u6E29%u5DDE%u5E02%u82CD%u5357%u53BF%u5B9C%u5C71%u9547%u9F99%u91D1%u5DE5%u4E1A%u56ED%u533A2%u680B105%u7EB8%u5DFE%u5382; wq_addr=2089432507%7C15_1233_1241_42335%7C%u6D59%u6C5F_%u6E29%u5DDE%u5E02_%u82CD%u5357%u53BF_%u5B9C%u5C71%u9547%7C%u6D59%u6C5F%u6E29%u5DDE%u5E02%u82CD%u5357%u53BF%u5B9C%u5C71%u9547%u9F99%u91D1%u5DE5%u4E1A%u56ED%u533A2%u680B105%u7EB8%u5DFE%u5382%7C120.530609%2C27.518864; jdAddrId=15_1233_1241_42335; jdAddrName=%u6D59%u6C5F_%u6E29%u5DDE%u5E02_%u82CD%u5357%u53BF_%u5B9C%u5C71%u9547; regionAddress=15%2C1233%2C1241%2C42335;'  # 京东固定cookie值，需修改。

# 下面设置暂无需更改
url = ''
expected_price = 1.00
push_server_addr = 'https://www.pushplus.plus/send?token={}&title={}&content={}'  # pushplus推送信息API接口地址
